...
import FormGroups			from 'components/form/FormGroups.jsx';

import BookOptionComponent	from 'components/form/input/select/BookOptionComponent.jsx';
import BookValueComponent	from 'components/form/input/select/BookValueComponent.jsx';


import Utilities			from 'utilities/Utilities.js';
import {arrayGenerator, selectGenerator, textAreaGenerator}
							from 'utilities/web/FieldGenerators.js';


import {JSONTreeTheme, API_URL, COLOR_SUCCESS, COLOR_FAILURE, COLOR_INFO}
							from 'constants';
...
class Book extends React.Component{
	...
	handleOnChange(id, value){
		...
		if(bookId === "new"){
			...
			if(Utilities.updatePropertyByString(book, id, value)){
				dispatch(
					updateNewBook(book)
				);
			}
