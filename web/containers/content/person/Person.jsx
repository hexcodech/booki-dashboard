...
import { checkboxInput } from "web/utilities/input-types";
...
class Person extends React.Component {
	...
	handleOnAddNewPerson(e) {
		...
		dispatch(postPerson(person, accessToken)).then(postedPerson => {
			if (postedPerson) {
				dispatch(
					addNotification({
						title: "Created",
				...
				dispatch(push("/person/" + postedPerson.id + "/"));
	...
	handleOnDeletePerson(e) {
		...
		dispatch(deletePerson(person, accessToken)).then(success => {
			if (success) {
				dispatch(
					addNotification({
						title: "Deleted",
